...
\newcommand{\testosommario}{Il seguente documento ha lo scopo di illustrare quali operazioni dovr\'a eseguire un installatore per installare correttamente il sistema LiquidFeedback all'interno del proprio server}
